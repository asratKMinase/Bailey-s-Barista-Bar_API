...
public class ClassesServlet {
    ...
    public ResponseEntity<Classes> findClasses(@RequestParam String classesName) {
    ...
    public ResponseEntity<Classes> CreateClasses(@RequestBody ClassesInitializer newClassesi, HttpSession req)  {
        ...
        newClasses.setClassid(newClassesi.getClassid());
    ...
    public void deleteClasses(String classid){
        boolean newClasses = classesServices.delete(classid);
    }
}
